...
namespace Altinn.Studio.Designer.TypedHttpClients.AltinnStorage
{
    ...
    public interface IAltinnStorageTextResourceClient
    {
        ...
        public Task<TextResource> Get(string org, string repo, string language, EnvironmentModel environmentModel);
        ...
        /// <param name="environmentModel">the environment model</param>
        public Task Create(string org, string repo, TextResource textResource, EnvironmentModel environmentModel);
        ...
        /// <param name="environmentModel">the environment model</param>
        public Task Update(string org, string repo, TextResource textResource, EnvironmentModel environmentModel);
    }
}
