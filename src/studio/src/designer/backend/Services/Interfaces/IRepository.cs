...
namespace Altinn.Studio.Designer.Services.Interfaces
{
    ...
    public interface IRepository
    {
        ...
        bool CreateModel(string org, string repo, ModelMetadata serviceMetadata, XDocument mainXsd, string fileName);
        ...
        ModelMetadata GetModelMetadata(string org, string repo);
        ...
        string GetConfiguration(string org, string repo, string name);
        ...
        /// <returns>The fileContent</returns>
        string GetFileByRelativePath(string org, string repo, string fileName);
        ...
        string GetLanguageResource(string org, string repo, string id);
        ...
        void UpdateViewNameTextResource(string org, string repo, string currentName, string newName);
        ...
        string GetAppModel(string org, string repo);
        ...
        void DeleteTextResource(string org, string repo, string name);
        ...
        bool SaveConfiguration(string org, string repo, string name, string config);
        ...
        /// <returns>A boolean indicating if saving was ok</returns>
        bool SaveLanguageResource(string org, string repo, string id, string resource);
        ...
        bool DeleteLanguage(string org, string repo, string id);
        ...
        /// <param name="resource">The content of the resource file</param>
        /// <returns>A boolean indicating if saving was ok</returns>
        bool SaveRuleConfigJson(string org, string repo, string resource);
        ...
        /// <returns>A boolean indicating if saving was ok</returns>
        bool UpdateModelMetadata(string org, string repo, ModelMetadata modelMetadata, string modelName);
        ...
        bool DeleteService(string org, string repo);
        ...
        Dictionary<string, Dictionary<string, TextResourceElement>> GetServiceTexts(string org, string repo);
        ...
        List<string> GetLanguages(string org, string repo);
        ...
        List<AltinnCoreFile> GetImplementationFiles(string org, string repo);
        ...
        List<AltinnCoreFile> GetDynamicsFiles(string org, string repo);
        ...
        /// <param name="repo">Application identifier which is unique within an organisation.</param>
        /// <returns>A list of file names</returns>
        List<AltinnCoreFile> GetCalculationFiles(string org, string repo);
        ...
        /// <param name="repo">Application identifier which is unique within an organisation.</param>
        /// <returns>A list of file names</returns>
        List<AltinnCoreFile> GetValidationFiles(string org, string repo);
        ...
        string GetAppLogic(string org, string repo, string fileName);
        ...
        string GetResourceFile(string org, string repo, string fileName);
        ...
        void SaveAppLogicFile(string org, string repo, string fileName, string fileContent);
        ...
        /// <param name="fileName">The file name</param>
        /// <param name="fileContent">The file content</param>
        void SaveResourceFile(string org, string repo, string fileName, string fileContent);
        ...
        /// <returns>A boolean indicating if saving was ok</returns>
        bool SaveRuleHandler(string org, string repo, string content);
        ...
        bool SaveFile(string org, string repo, string fileName, string fileContent);
        ...
        /// </remarks>
        void SaveServiceTexts(string org, string repo, Dictionary<string, Dictionary<string, TextResourceElement>> texts);
        ...
        string GetXsdModel(string org, string repo);
        ...
        string GetJsonSchemaModel(string org, string repo);
        ...
        byte[] GetServiceResource(string org, string repo, string resource);
        ...
        string GetJsonFormLayouts(string org, string repo);
        ...
        /// <param name="repo">Application identifier which is unique within an organisation.</param>
        /// <returns>Returns the json object as a string</returns>
        string GetJsonThirdPartyComponents(string org, string repo);
        ...
        /// <param name="repo">Application identifier which is unique within an organisation.</param>
        /// <returns>Returns the json object as a string</returns>
        string GetRuleHandler(string org, string repo);
        ...
        /// <param name="content">The content of the resource file</param>
        /// <returns>A boolean indicating if saving was ok</returns>
        bool SaveFormLayout(string org, string repo, string formLayout, string content);
        ...
        bool UpdateFormLayoutName(string org, string repo, string currentName, string newName);
        ...
        bool DeleteFormLayout(string org, string repo, string formLayout);
        ...
        bool SaveLayoutSettings(string org, string repo, string setting);
        ...
        string GetLayoutSettings(string org, string repo);
        ...
        /// <param name="resource">The content of the resource file</param>
        /// <returns>A boolean indicating if saving was ok</returns>
        bool SaveJsonThirdPartyComponents(string org, string repo, string resource);
        ...
        /// <param name="repo">Application identifier which is unique within an organisation.</param>
        /// <returns>The content as string</returns>
        string GetWidgetSettings(string org, string repo);
        ...
        bool AddTextResources(string org, string repo, List<TextResource> textResourcesList);
        ...
        /// <returns>A boolean indicating if saving was ok</returns>
        bool SaveJsonFile(string org, string repo, string resource, string fileName);
        ...
        /// <param name="fileName">The file name</param>
        /// <returns>Returns the json object as a string</returns>
        string GetJsonFile(string org, string repo, string fileName);
        ...
        /// <returns></returns>
        bool AddMetadataForAttachment(string org, string repo, string applicationMetadata);
        ...
        /// <param name="applicationMetadata">the application metadata to be updated</param>
        /// <returns></returns>
        bool UpdateMetadataForAttachment(string org, string repo, string applicationMetadata);
        ...
        /// <returns></returns>
        bool DeleteMetadataForAttachment(string org, string repo, string id);
        ...
        bool UpdateServiceInformationInApplication(string org, string repo, ServiceConfiguration applicationInformation);
        ...
        PlatformStorageModels.Application GetApplication(string org, string repo);
        ...
        void CreateApplicationMetadata(string org, string repo, string appTitle);
        ...
        bool UpdateApplication(string org, string repo, PlatformStorageModels.Application applicationMetadata);
        ...
        bool UpdateAppTitle(string org, string repo, string languageId, string title);
        ...
        /// <returns></returns>
        string GetPrefillJson(string org, string repo, string dataModelName = "ServiceModel");
        ...
        /// <param name="repo">Application identifier which is unique within an organisation.</param>
        /// <returns></returns>
        string GetAppPath(string org, string repo);
        ...
        void UpdateApplicationWithAppLogicModel(string org, string repo, string dataTypeId, string classRef);
    }
}
